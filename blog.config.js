...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '拆包机系统设计师🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kjco.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '无锡宝隆化工, 博客', // 网站关键词 英文逗号隔开
